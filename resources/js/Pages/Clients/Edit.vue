...
<template>
  <AppLayout :title="t('clients.edit_client')">
    <template #header>
        ...
        <form @submit.prevent="submitForm">
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div class="sm:col-span-2">
              <label for="name" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">{{ t('clients.client_name') }}</label>
            ...
            <div class="w-full">
              <label for="email" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">{{ t('clients.email') }}</label>
            ...
            <div class="w-full">
              <label for="phone_number" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">{{ t('clients.phone_number') }}</label>
            ...
            <div class="sm:col-span-2">
              <label for="address" class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">{{ t('clients.address') }}</label>
            ...
            <div class="sm:col-span-2">
              <label for="notes"
                class="block mb-2 text-xs font-medium text-gray-400 dark:text-white">{{ t('clients.notes') }}</label>
